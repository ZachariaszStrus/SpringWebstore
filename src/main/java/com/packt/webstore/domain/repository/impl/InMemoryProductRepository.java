...
public class InMemoryProductRepository implements ProductRepository{
    ...
    public InMemoryProductRepository() {
        ...
        laptop_dell.setDescription("Dell Inspiron, 14-calowy laptop (czarny) z "
                + "procesorem Intel Core 3. generacji");
        laptop_dell.setCategory("Laptop");
        laptop_dell.setManufacturer("Dell");
        laptop_dell.setUnitsInStock(1000);
        Product tablet_Nexus = new Product("P1236","Nexus 7", new BigDecimal(300));
        tablet_Nexus.setDescription("Google Nexus 7 jest najlżejszym 7-calowym tabletem z "
                + "4-rdzeniowym procesorem Qualcomm SnapdragonTM S4 Pro");
